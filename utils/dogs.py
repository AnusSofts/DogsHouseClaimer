...
class DogsHouse:
    ...
    async def login(self):
        ...
        return r.get('balance'), r.get('age'), r.get('last_seen')
    ...
    async def get_daily(self):
        ...
        r = await (await self.session.get('https://api.onetime.dog/rewards', params=params)).json()

        return r.get('daily'), r.get('total')
